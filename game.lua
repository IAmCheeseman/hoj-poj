...
input.addAction("select_slot_1", "kb", "1")
input.addAction("select_slot_2", "kb", "2")
input.addAction("select_slot_3", "kb", "3")
input.addAction("select_slot_4", "kb", "4")
input.addAction("select_slot_5", "kb", "5")
input.addAction("select_slot_6", "kb", "6")
input.addAction("select_slot_7", "kb", "7")
input.addAction("select_slot_8", "kb", "8")
